...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        if tableName.lower()=="xueshengqingjia":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "xueshengqingjia":
            urlpatterns.extend(
                [
                    path(r'{}/typeStat/qingjialeixing/xingming'.format(tableName.lower()),
                         eval("{}_v.{}_typeStat_qingjialeixing_xingming".format(tableName.capitalize(), tableName.lower()))),
                ]
            )
        if tableName.lower() == "xueshengqingjia":
            urlpatterns.extend(
        ...
        if tableName.lower()=="leavedataforecast":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
