		...
		<div class="login-container">
			<el-form class="login_form animate__animated animate__fadeInDown">
				<div class="login_form2">
					<div class="title-container">基于Python+Django的大学生请假管理系统</div>
					...
					<div class="login-btn">
						...
						<div class="login-btn2">
							<el-button type="primary" @click="register('xuesheng')" class="register">
								注册学生							</el-button>
							<el-button type="primary" @click="register('fudaoyuan')" class="register">
								注册辅导员							</el-button>
						</div>
