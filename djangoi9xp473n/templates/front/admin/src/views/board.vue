		...
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="xueshengChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 45px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) center center/100% 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="fudaoyuanChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"padding":"0 0 10px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"10px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"84px"}'>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"175px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>学生总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(30, 144, 255)","fontWeight":"bold","height":"24px","order":"20"}'>{{xueshengCount}}</div>
						</div>
					</div>

					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"200px"}'>
						<div :style='{"width":"12px","margin":"0","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>辅导员总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(246, 192, 12)","fontWeight":"bold","height":"24px","order":"20"}'>{{fudaoyuanCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"200px"}'>
						<div :style='{"width":"12px","margin":"0","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>学生请假总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"#00fbff","fontWeight":"bold","height":"24px","order":"20"}'>{{xueshengqingjiaCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="xueshengqingjiaChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="leavedataforecastChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="forecast-box" :style='{"border":"none","padding":"20px","margin":"0","flexWrap":"wrap","background":"none","flex":"0 0 auto","display":"flex","width":"30%","transition":"0.3s","height":"calc(40% - 42px)","order":"10"}'>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							学期
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.semester" placeholder="请输入学期"></input>
					</div>
					<div :style='{"border":"1px solid #999","padding":"0 10px","margin":"0 0 10px 0","alignItems":"center","display":"flex","width":"100%","order":"2"}'>
						<div :style='{"width":"auto","color":"#999","textAlign":"left","order":"1"}'>
							学号
						</div>
						<input :style='{"border":"none","padding":"0 10px","margin":"0","color":"rgb(30, 144, 255)","background":"none","flex":"auto","width":"0","lineHeight":"30px","height":"30px"}' v-model="forecastForm.studentid" placeholder="请输入学号"></input>
					</div>
					<div :style='{"width":"100%","fontSize":"16px","lineHeight":"40px","color":"rgb(30, 144, 255)","textAlign":"left"}'>
						预测请假次数：{{form.numberofleaverequests}}
					</div>
					<div @click="forecastClick" :style='{"border":"1px solid rgb(30, 144, 255)","cursor":"pointer","margin":"0 auto","color":"rgb(30, 144, 255)","borderRadius":"5px","textAlign":"center","background":"none","width":"100%","lineHeight":"34px","height":"34px","order":"2"}'>
						立即预测
					</div>
				</div>
			</div>
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="xueshengqingjiaChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="xueshengqingjiaChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		created() {
			this.$nextTick(()=>{
				...
				setTimeout(()=>{
					...
					this.xueshengChat1();
					this.getfudaoyuanCount();
					this.fudaoyuanChat2();
					this.getxueshengqingjiaCount();
					this.xueshengqingjiaChat3();
					this.xueshengqingjiaChat4();
					this.xueshengqingjiaChat5();
					this.leavedataforecastChat6();
				},500)
			})
		},
		methods:{
				...
				this.$confirm(`是否进行数据预测?`, "提示", {
					...
					this.$http({
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								url: 'leavedataforecast/forecast',
								method: 'post',
								data: this.forecastForm
							}).then(obj=>{
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'leavedataforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			fudaoyuanChat2() {
				this.$nextTick(()=>{
					...
					var fudaoyuanChart2 = echarts.init(document.getElementById("fudaoyuanChart2"),'macarons');
					this.$http({
						url: "fudaoyuan/group/xingbie",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							fudaoyuanChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								fudaoyuanChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			getxueshengqingjiaCount() {
				this.$http({
					url: `xueshengqingjia/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.xueshengqingjiaCount = data.data
					}
				})
			},
			//统计接口1
			xueshengqingjiaChat3() {
				this.$nextTick(()=>{

					var xueshengqingjiaChart3 = echarts.init(document.getElementById("xueshengqingjiaChart3"),'macarons');
					this.$http({
						url: "xueshengqingjia/typeStat/qingjialeixing/xingming",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
// typeSections [com.jlwl.entity.TypeSection@2523c668, com.jlwl.entity.TypeSection@46497e9a, com.jlwl.entity.TypeSection@fba853b]
							let xAxis = [];
							let yAxis1 = [];
							let yAxis2 = [];
							let yAxis3 = [];
							...
							for(let i=0;i<res.length;i++){
								...
								yAxis1.push(parseFloat((res[i].病假)));
								yAxis2.push(parseFloat((res[i].事假)));
								yAxis3.push(parseFloat((res[i].其他)));
								pArray.push({
									name: res[i].qingjialeixing
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							xueshengqingjiaChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								xueshengqingjiaChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口2
			xueshengqingjiaChat4() {
				this.$nextTick(()=>{

					var xueshengqingjiaChart4 = echarts.init(document.getElementById("xueshengqingjiaChart4"),'macarons');
					this.$http({
						url: "xueshengqingjia/group/xingming",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							xueshengqingjiaChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								xueshengqingjiaChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口3
			xueshengqingjiaChat5() {
				this.$nextTick(()=>{

					var xueshengqingjiaChart5 = echarts.init(document.getElementById("xueshengqingjiaChart5"),'macarons');
					this.$http({
						url: "xueshengqingjia/group/banji",
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							xueshengqingjiaChart5.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								xueshengqingjiaChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			//统计接口1
			leavedataforecastChat6() {
				this.$nextTick(()=>{

					var leavedataforecastChart6 = echarts.init(document.getElementById("leavedataforecastChart6"),'macarons');
					this.$http({
						url: `leavedataforecast/value/studentid/numberofleaverequests`,
						method: "get",
						params: {
							order: 'desc'
						}
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							leavedataforecastChart6.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								leavedataforecastChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
