	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'" label="辅导工号" prop="fudaogonghao" >
					<el-select :disabled="ro.fudaogonghao" @change="fudaogonghaoChange" v-model="ruleForm.fudaogonghao" placeholder="请选择辅导工号">
						<el-option
							v-for="(item,index) in fudaogonghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item class="input" v-else-if="ruleForm.fudaogonghao" label="辅导工号" prop="fudaogonghao" >
					<el-input v-model="ruleForm.fudaogonghao" placeholder="辅导工号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="辅导姓名" prop="fudaoxingming" >
					<el-input v-model="ruleForm.fudaoxingming" placeholder="辅导姓名" clearable  :readonly="ro.fudaoxingming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="辅导姓名" prop="fudaoxingming" >
					<el-input v-model="ruleForm.fudaoxingming" placeholder="辅导姓名" readonly></el-input>
				</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='fudaogonghao'){
							this.ruleForm.fudaogonghao = obj[o];
							this.ro.fudaogonghao = true;
							continue;
						}
						if(o=='fudaoxingming'){
							this.ruleForm.fudaoxingming = obj[o];
							this.ro.fudaoxingming = true;
							continue;
						}
						if(o=='touxiang'){
				...
				this.$http({
					...
					if (data && data.code === 0) {
						var json = data.data;
						if(((json.fudaogonghao!=''&&json.fudaogonghao) || json.fudaogonghao==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.fudaogonghao = json.fudaogonghao
							this.ro.fudaogonghao = true;
						}
						if(((json.fudaoxingming!=''&&json.fudaoxingming) || json.fudaoxingming==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.fudaoxingming = json.fudaoxingming
							this.ro.fudaoxingming = true;
						}
					} else {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.fudaogonghaoOptions = data.data;
					} else {
						this.$message.error(data.msg);
					}
				});
