...
import center from '@/views/center'
	...
	import leavedataforecast from '@/views/modules/leavedataforecast/list'
	import banjixinxi from '@/views/modules/banjixinxi/list'
	import fudaoyuan from '@/views/modules/fudaoyuan/list'
	import leavedata from '@/views/modules/leavedata/list'
...
export const routes = [{
	...
	,{
		path: '/leavedataforecast',
		name: '请假次数预测',
		component: leavedataforecast
	}
	,{
		path: '/banjixinxi',
		name: '班级信息',
